...
let rec read_directory_object _h =
  ...
  let rec createDirObj data = match data with
    ...
    | [txt] ->
        ...
        else [(List.hd txtData, true, (List.nth txtData 2), read_directory_object ( Digest.from_hex (List.nth txtData 2 )))]
    | hd::tl ->
        ...
        else (List.hd txtData, true, (List.nth txtData 2), read_directory_object ( Digest.from_hex (List.nth txtData 2) ))::(createDirObj(tl))
  in
